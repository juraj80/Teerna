...
export default {
    ...
    background: {
		...
		chat: transparentize(0.05, colour.grey[20]),
		console: transparentize(0.5, colour.white),
		centre: transparentize(0.5, colour.grey[0]),
		headerbar: transparentize(0.5, colour.grey[20]),
		appbar: transparentize(0.55, colour.white),
		sidebar: transparentize(0.5, colour.white),
		modal: '',
		button: colour.blue[0],
		input: colour.grey[20],
		tooltip: colour.grey[160],
		zone: transparentize(0.3,colour.grey[140]),
		hover: {
			headerbar: transparentize(0.3, colour.grey[0]),
	...
	text: {
		...
		chat: colour.grey[280],
		console: colour.grey[240],
		centre: colour.black,
		headerbar: colour.grey[0],
		appbar: colour.grey[220],
		sidebar: transparentize(0.65, colour.grey[260]),
		modal: '',
		button: '',
		input: colour.grey[280],
		tooltip: colour.black,
		zone: colour.grey[300],
		hover: {
	...
	border: {
		chat: colour.grey[260],
		headerbar: transparentize(0.8,colour.white),
		appbar: colour.grey[220],
		sidebar: transparentize(0.2, colour.white),
		modal: '',
		input: colour.grey[280],
		zone: colour.grey[300],
	},
